use super::Client;
use azure_sdk_core::COMPLETE_ENCODE_SET;
...
/// Azure documentation:
/// https://docs.microsoft.com/en-us/rest/api/storageservices/create-service-sas#specifying-the-signed-version-field
#[derive(Copy, Clone)]
pub enum SasVersion {
    V20181109,
    V20150405,
...
/// Azure documentation:
/// https://docs.microsoft.com/en-us/rest/api/storageservices/create-service-sas#specifying-the-http-protocol
#[derive(Copy, Clone)]
...
/// Azure documentation:
/// https://docs.microsoft.com/en-us/rest/api/storageservices/create-service-sas#specifying-the-signed-resource-blob-service-only
/// https://docs.microsoft.com/en-us/rest/api/storageservices/create-service-sas#specifying-the-signed-resource-file-service
#[derive(Copy, Clone)]
...
impl SharedAccessSignature {
    // TODO: don't use a default but a similar system of XSet and XRequired traits
    ...
    /// See: https://docs.microsoft.com/en-us/rest/api/storageservices/create-service-sas#service-sas-example
...
pub trait ClientSharedAccessSignature {
    fn sas<'a>(&'a self) -> SharedAccessSignatureBuilder;
}

impl ClientSharedAccessSignature for Client {
    fn sas<'a>(&'a self) -> SharedAccessSignatureBuilder {
        SharedAccessSignature::new(self.account(), self.key())
    }
}
